...
function showQuote() {
    ...
    document.getElementById("quote-text").textContent = quotePool[randomIndex].quoteText;
    document.getElementById("quote-author").textContent = quotePool[randomIndex].quoteAuthor;
}
showQuote();